...
|---------|---------------------|----------|
| `/assess` | `Level [N] - [Level Name] - Quick Assessment - YYYY-MM-DD` | `Level 2 - Optimization - Quick Assessment - 2026-07-10` |
| `/assess-full` | `Level [N] - [Level Name] - Comprehensive Assessment - YYYY-MM-DD` | `Level 2 - Optimization - Comprehensive Assessment - 2026-07-10` |
| `/assess-level0` | `Level 0 - Foundation - Validation Report - YYYY-MM-DD` | `Level 0 - Foundation - Validation Report - 2026-07-10` |
| `/assess-level1` | `Level 1 - Standardization - Validation Report - YYYY-MM-DD` | `Level 1 - Standardization - Validation Report - 2026-07-10` |

### Level 0 Commands

| Command | Notebook Name Format | Example |
|---------|---------------------|----------|
| `/level0-infra` | `Level 0 - Foundation - Infrastructure Discovery - YYYY-MM-DD` | `Level 0 - Foundation - Infrastructure Discovery - 2026-07-10` |
| `/level0-tagging` | `Level 0 - Foundation - Tagging Audit - YYYY-MM-DD` | `Level 0 - Foundation - Tagging Audit - 2026-07-10` |
| `/level0-cost` | `Level 0 - Foundation - Cost Baseline - YYYY-MM-DD` | `Level 0 - Foundation - Cost Baseline - 2026-07-10` |
| `/level0-healthcheck` | `Level 0 - Foundation - Health Check - YYYY-MM-DD` | `Level 0 - Foundation - Health Check - 2026-07-10` |

### Level 2+ Commands

| Command | Notebook Name Format | Example |
|---------|---------------------|----------|
| `/level2-tagging` | `Level 2 - Optimization - Advanced Tagging Strategy - YYYY-MM-DD` | `Level 2 - Optimization - Advanced Tagging Strategy - 2026-07-10` |
| `/level3-cost` | `Level 3 - Intelligence - Cost Optimization - YYYY-MM-DD` | `Level 3 - Intelligence - Cost Optimization - 2026-07-10` |

### Analysis Commands

| Command | Notebook Name Format | Example |
|---------|---------------------|----------|
| `/gap-analysis` | `Level [N] to Level [M] - Gap Analysis - YYYY-MM-DD` | `Level 2 to Level 3 - Gap Analysis - 2026-07-10` |
| `/upgrade-plan` | `Level [N] to Level [N+1] - Upgrade Plan - YYYY-MM-DD` | `Level 2 to Level 3 - Upgrade Plan - 2026-07-10` |

### Reporting Commands

| Command | Notebook Name Format | Example |
|---------|---------------------|----------|
| `/generate-report` | `Level [N] - [Level Name] - Executive Report - YYYY-MM-DD` | `Level 2 - Optimization - Executive Report - 2026-07-10` |
...
1. **By Level**:
   ```
   📁 Level 0 - Foundation
      - Infrastructure Discovery - 2026-07-10
      - Tagging Audit - 2026-07-10
      - Cost Baseline - 2026-07-10
   📁 Level 1 - Standardization
   📁 Level 2 - Optimization
      - Quick Assessment - 2026-07-10
      - Gap Analysis - 2026-07-10
   ...
   ```
...
2. **By Date** (for tracking progress):
   ```
   📁 2026-Q3
      - Level 2 - Quick Assessment - 2026-07-10
      - Level 0 - Tagging Audit - 2026-07-10
   📁 2026-Q2
   ...
   ```
...
3. **By Report Type** (for leadership):
   ```
   📁 Executive Reports
      - Level 2 - Executive Report - 2026-07-10
   📁 Assessments
   📁 Audits
   ...
   ```
...
- Easy to find by date: search "2026-07"
...
- Example: "Level 2 - Optimization - Assessment - 2026-07-10"
...
| `[DATE]` | ISO format date (YYYY-MM-DD) | `2026-07-10` |
...
Example: `Level Unknown - Assessment - 2026-07-10`
...
### Quarterly Reviews
```
Level 2 - Optimization - Q4 Assessment - 2026-07-10
Level 2 - Optimization - Gap Analysis - 2026-07-10
Level 2 - Optimization - Executive Report - 2026-07-10
```

### Level Advancement Campaign
```
Level 0 - Foundation - Tagging Audit - 2026-07-10
Level 0 - Foundation - Tagging Audit - 2026-07-10
Level 0 - Foundation - Tagging Audit - 2026-07-10
Level 1 - Standardization - Validation Report - 2026-07-10
```
...
Level 2 - Optimization - Executive Report - 2026-07-10
Level 2 - Optimization - Executive Report - 2026-07-10
Level 3 - Intelligence - Executive Report - 2026-07-10
```
...
1. **Team Prefix** (optional):
   ...
   - Example: `Platform-SRE - Level 2 - Assessment - 2026-07-10`

2. **Environment Suffix** (for multi-tenant):
   - `Level [N] - [Report] - [Environment] - [Date]`
   - Example: `Level 2 - Assessment - Production - 2026-07-10`

3. **Version Numbers** (for iterations):
   - `Level [N] - [Report] - [Date] - v[Version]`
   - Example: `Level 2 - Assessment - 2026-07-10 - v2`
